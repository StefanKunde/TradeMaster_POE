...
public class PanelSingleMaps extends PanelBase {
    ...
    protected void initTab() {
        ...
        lblLoading.setIcon(new ImageIcon(Main.class.getResource("/images/Spinner.gif")));
        ...
        // COMBO BOXEs
        cmb_tier = new JComboBox(Config.get().MAP_TIERS);
        ...
        cmb_currency = new JComboBox(Config.get().getBulkBuyWithCurrencies());
